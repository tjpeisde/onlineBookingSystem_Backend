...
import com.tjpeisde.onlinebooking.exception.GCSUploadException;
...
public class ImageStorageService {
    ...
    public String save(MultipartFile file) throws GCSUploadException {
        ...
        try {//get file from resources folder
            credentials =
                    GoogleCredentials.fromStream(getClass().getClassLoader().getResourceAsStream("credentials.json"));
        } catch (IOException e) {
