...
@Entity
@Table(name = "stay")
@JsonDeserialize(builder = Stay.Builder.class)//从前端Json变成Object用Builder class
//Jackson 用来转换Json格式数据到Java Code
public class Stay implements Serializable {
    ...
    public static class Builder {//static 所以不用实例化
        @JsonProperty("id")
        private Long id;
        @JsonProperty("name")
        private String name;
        ...
        public Builder setAvailabilities(List<StayAvailability>
                                                 availabilities) {
            this.availabilities = availabilities;
            return this;
        }
