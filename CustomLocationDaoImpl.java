...
public class CustomLocationDaoImpl implements CustomLocationDao{
    ...
    @Autowired
    CustomLocationDaoImpl(ElasticsearchOperations elasticsearchOperations){
    ...
    public List<Long> searchByDistance(double lat, double lon, String distance) {
        ...
        SearchHits<Location> searchResult = elasticsearchOperations
                .search(queryBuilder.build(), Location.class);
